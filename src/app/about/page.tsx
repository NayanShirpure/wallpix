...
import { ArrowLeft, Info, Users, Target } from 'lucide-react'; // Removed social icons
...
export default function AboutUsPage() {
  ...
  return (
    <>
      ...
      <main className="flex-grow container mx-auto max-w-4xl p-4 py-8 md:p-6 md:py-12"> {/* flex-grow to ensure main content takes available space */}
