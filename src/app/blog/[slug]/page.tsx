          ...
          <div className="flex flex-col sm:flex-row justify-between gap-6">
            ...
            {newerPost ? (
              <Link
                ...
                className="group flex-1 block p-4 sm:p-5 rounded-lg border bg-card hover:border-accent transition-colors duration-200 shadow-sm hover:shadow-md text-left sm:text-right focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-background"
              >
